...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "berkeley-classes",
		Short: `Search every Berkeley class, sync the full term offline, build conflict-free schedules, and watch waitlists.`,
		Long: `Search every Berkeley class, sync the full term offline, build conflict-free schedules, and watch waitlists.
...
Health check: run 'berkeley-classes doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("berkeley-classes {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'berkeley-classes profile list')")
	...
	rootCmd.AddCommand(newNovelConflictCmd(flags))
	rootCmd.AddCommand(newNovelDeptCmd(flags))
	rootCmd.AddCommand(newNovelInstructorCmd(flags))
	rootCmd.AddCommand(newNovelOpenCmd(flags))
